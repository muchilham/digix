...
<head>
    ...
    <title>Subject Detail Question | Digix</title>
...
<body class="fix-header card-no-border">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url();?>adm/question">Question</a></li>
                        <li class="breadcrumb-item active">Subject Detail Question</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate action="<?php echo base_url(); ?>adm/question/proses_add_subject_detail_question" enctype="multipart/form-data" id="frm-example" method="POST">
                                    <div class="form-group">
                                      <input type="hidden" name="id_subject_detail" value="<?php echo $id_subject_detail; ?>">
                                    </div>
                                    <div class="form-group">
                                        <div class="table-responsive m-t-40">
                                            <table id="myTable" class="table table-bordered table-striped">
                                              ...
                                              <tbody>
                                              <?php $no=1; foreach($select_question_get_by_subject_detail->result() as $row_question){ ?>
                                                  <tr>
                                                      <td><input type="checkbox" onchange="checked_question(this,<?php echo $row_question->id_question; ?>);">
                                                      <td><?php echo $no++; ?></td>
                                                      <td><?php echo $row_question->question; ?></td>
                                                      <td><img src="<?php echo base_url(); ?>assets/adm/images/question/<?php echo $row_question->question_image; ?>" alt="question" width="120" class="img-rounded"></td>
                                                      <td>
                                                        <?php 
                                                      ...
                                                      <div class="modal-dialog">
                                                          <div class="modal-content">
                                                              ...
                                                              <div class="modal-footer">
                                                                  <a href="<?php echo base_url(); ?>adm/question/delete_question/<?php echo $row_question->id_question; ?>" class="btn btn-info">Yes</a>
                                    ...
                                    <div class="text-xs-right pull-right">
                                        ...
                                        <a href="<?php echo base_url();?>adm/question/subject_detail_question" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
      ...
      function checked_question(checkbox,value) {
        ...
        document.getElementById("id_question").value = data_question.toString();
      }
    ...
    // var checkbox = document.getElementsByClassName('.checkbox_question');
