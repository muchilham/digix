                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40 form-material" method="post" action="<?php echo base_url(); ?>adm/question/proses_update_question_essay/<?php echo $id_question; ?>/<?php echo $id_module;?>" enctype="multipart/form-data">
