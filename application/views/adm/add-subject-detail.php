            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url();?>adm/subject">subject</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate method="post" action="<?php echo base_url(); ?>adm/subject/proses_add_subject_detail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="subject_detail_name" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    </div>
                                    <div class="form-group">
                                        <h5>Subject Description<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <textarea name="subject_detail_description" id="textarea" class="form-control" required></textarea>
                                        </div>
                                    </div>
