                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url(); ?>adm/subject/add_subject"><button type="button" class="btn btn-info btn-sm" aria-haspopup="true" aria-expanded="false"><i class="ti-plus"></i> Add</button></a>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <?php $no=1; foreach($select_subject->result() as $row_subject){ ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo $row_subject->subject_name; ?></td>
                                                <td><?php echo $row_subject->subject_description; ?></td>
                                                <td><?php echo $row_subject->subject_created; ?></td>
                                                <td><a href="<?php echo base_url(); ?>adm/subject/update_subject/<?php echo $row_subject->id_subject; ?>"><button type="button" class="btn btn-warning btn-sm" aria-haspopup="true" aria-expanded="false"><i class="ti-pencil"></i></button> </a> <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Delete<?php echo $row_subject->id_subject; ?>" aria-haspopup="true" aria-expanded="false"><i class="ti-trash"></i></button></td>
                                            </tr>

                                            <div id="Delete<?php echo $row_subject->id_subject; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url(); ?>adm/subject/delete_subject/<?php echo $row_subject->id_subject; ?>"><button type="submit" class="btn btn-info">Yes</button></a>
