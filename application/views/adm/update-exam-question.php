                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate method="post" action="<?php echo base_url(); ?>adm/exam/proses_update_exam_question/<?php echo $id_module."/".$id_exam_question; ?>">
                                            ...
                                            <select class="form-control" name="id_subject_detail">
                                                <?php foreach ($select_subject_detail->result() as $row_subject_detail) { ?>
                                                    <option value="<?php echo $row_subject_detail->id_subject_detail; ?>" 
                                                        <?php if($row_subject_detail->id_subject_detail == $select_exam_question->id_subject_detail)
                                                        {
                                                            echo "selected";
                                                        } ?>
                                                        >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" min="1" name="total_question" class="form-control" required data-validation-required-message="This field is required" value="<?php echo $select_exam_question->total_question;?>"> </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <?php 
                                                if($select_exam_question->is_tryout == 1) echo "checked"; 
                                                else echo ""; 
                                            ?>
                                            >
