            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>adm/category">category</a></li>
                        <li class="breadcrumb-item active">add categroy</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate method="post" action="<?php echo base_url(); ?>adm/category/proses_update_category/<?php echo $id_category; ?>">
                                    <div class="form-group">
                                        <h5>Category Name<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="category_name" class="form-control" required data-validation-required-message="This field is required" value="<?php echo $select_category->category_name; ?>"> </div>
                                    </div>
                                    <div class="form-group">
                                        <h5>Category Description<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <textarea name="category_description" id="textarea" class="form-control" required><?php echo $select_category->category_description; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="text-xs-right">
                                        <button type="submit" class="btn btn-info">Submit</button>
                                        <a href="<?php echo base_url();?>adm/category" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
