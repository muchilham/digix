            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>adm/account/user">account</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- <a href="<?php echo base_url(); ?>adm/account/add_account_admin"><button type="button" class="btn btn-info" aria-haspopup="true" aria-expanded="false"><i class="ti-plus"></i> Add</button></a> -->
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <?php $no=1; foreach($select_account->result() as $row_account){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Delete<?php echo $row_account->id_user; ?>" aria-haspopup="true" aria-expanded="false">
                                                        <i class="ti-trash"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url(); ?>adm/account/delete_account/<?php echo $row_account->id_user; ?>"><button type="submit" class="btn btn-info">Yes</button></a>
