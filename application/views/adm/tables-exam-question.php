            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exam Question Table</h4>
                                <div class="table-responsive m-t-40">
                                    <div id="notif"><?php echo $this->session->flashdata('notif'); ?></div>
                                    <a href="<?php echo base_url(); ?>adm/exam/add_exam_question/<?php echo $id_module."/".$exam_question_type;?>">
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <!-- <th>Is Random</th> -->
                                                <th>Is Try Out</th>
                                                <th>Exam Question Created</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php $no=1; foreach($select_exam_question->result() as $exam_question){ ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo $exam_question->module_name; ?></td>
                                                <td><?php echo $exam_question->subject_detail_name; ?></td>
                                                <td><?php echo $exam_question->total_question; ?></td>
                                                <!-- <td>
                                                    <?php 
                                                    // if ($exam_question->is_random == 1) echo "Yes";
                                                    // else echo "No"; 
                                                    ?>   
                                                </td> -->
                                                <td>
                                                    <?php 
                                                    if ($exam_question->is_tryout == 1) echo "Yes";
                                                    else echo "No"; 
                                                    ?>   
                                                </td>
                                                <td><?php echo $exam_question->exam_question_created; ?></td>
                                                <td>
                                                    <a href="<?php echo base_url(); ?>adm/exam/update_exam_question/<?php echo $id_module."/".$exam_question->id_exam_question; ?>">
                                                        <button type="button" class="btn btn-warning btn-sm" aria-haspopup="true" aria-expanded="false">
                                                            <i class="ti-pencil"></i>
                                                        </button> 
                                                    </a> 
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Delete<?php echo $exam_question->id_exam_question; ?>" aria-haspopup="true" aria-expanded="false">
                                                        <i class="ti-trash"></i>
                                                    </button>
                                                </td>
                                            </tr>

                                            <div id="Delete<?php echo $exam_question->id_exam_question; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url(); ?>adm/exam/delete_exam_question/<?php echo $exam_question->id_exam_question; ?>"><button type="submit" class="btn btn-info">Yes</button></a>
