...
<body class="fix-header card-no-border">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate action="<?php echo base_url(); ?>adm/question/proses_update_subject_detail_question" enctype="multipart/form-data" id="frm-example" method="POST">
                                    ...
                                    <div class="form-group">
                                                  ...
                                                  <tr>
                                                      <td>
                                                        <input type="checkbox" onchange="checked_question(this,<?php echo $row_question->id_question; ?>);"
                                                          <?php if($id_subject_detail == $row_question->id_subject_detail) 
                                                          { echo "checked"; } 
                                                          else echo ""; ?> 
                                                        >
                                                      <td><?php echo $no++; ?></td>
                                        ...
                                        <div>
                                          <input type="hidden" name="id_question1" value="<?php $replace = ['[', ']']; $torplace = ['', '']; echo str_replace($replace,$torplace,$select_question_get_by_subject_detail_checked);?>" id="id_question1">
    ...
    <script type="text/javascript">
      ...
      var data_question = JSON.parse('<?php echo $select_question_get_by_subject_detail_checked; ?>');
