                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Essay</h6>
                                ...
                                <div id="notif"><?php echo $this->session->flashdata('notif'); ?></div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <?php $no=1; foreach($select_answer_essay->result() as $row_essay){ ?>
                                            <tr>
                                                <td> <?php echo $no++; ?></td>
                                                <td><?php echo $row_essay->id_user; ?></td>
                                                <td><?php echo $row_essay->answer_score; ?></td>
                                                <td><?php echo $row_essay->answer_created; ?></td>
                                                <td><a href="<?php echo base_url(); ?>adm/answer/check_answer/<?php echo $row_essay->id_answer; ?>"><button type="button" class="btn btn-success btn-sm" aria-haspopup="true" aria-expanded="false"><i class="ti-pencil"></i> Check</button> </a> 
                                        <!--<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Delete" aria-haspopup="true" aria-expanded="false"><i class="ti-trash"></i> Delete</button>-->
                                        </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url(); ?>adm/account/delete_account/"><button type="submit" class="btn btn-info">Yes</button></a>
