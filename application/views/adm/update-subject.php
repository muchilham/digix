                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate method="post" action="<?php echo base_url(); ?>adm/subject/proses_update_subject/<?php echo $id_subject; ?>">
                                    <div class="form-group">
                                        <h5>Subject Name<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="subject_name" class="form-control" required data-validation-required-message="This field is required" value="<?php echo $select_subject->subject_name; ?>"> </div>
                                    </div>
                                    <div class="form-group">
                                        <h5>Subject Description<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <textarea name="subject_description" id="textarea" class="form-control" required><?php echo $select_subject->subject_description; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="text-xs-right">
                                        <button type="submit" class="btn btn-info">Submit</button>
                                        <a href="<?php echo base_url();?>adm/subject" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
