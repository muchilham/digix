                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate method="post" action="<?php echo base_url(); ?>adm/category/proses_add_category">
                                    <div class="form-group">
                                        <h5>Category Name<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="category_name" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    </div>
                                    <div class="form-group">
                                        <h5>Category Description<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <textarea name="category_description" id="textarea" class="form-control" required></textarea>
                                        </div>
                                    </div>
