                                ...
                                <form class="m-t-40 form-material" method="post" action="<?php echo base_url(); ?>adm/exam/proses_update_exam/<?php echo $id_exam; ?>" enctype="multipart/form-data">
                                    ...
                                    foreach ($select_exam_category->result() as $row_exam_category) { ?>
                                        <div id="delete_category<?php echo $counter_category; ?>">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p class="pull-right text-danger"><a onclick="close_category(<?php echo $counter_category; ?>)"><i class="ti-close"></i> Delete</a></p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group m-b-40">
                                                        <select class="form-control" name="category[]">
                                                            <?php foreach ($select_category->result() as $row_category) { ?>
                                                                <option value="<?php echo $row_category->id_category; ?>" <?php if($row_category->id_category == $row_exam_category->id_category){ echo "selected"; } ?>><?php echo $row_category->category_name; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
