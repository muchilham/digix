...
<head>
    ...
    <title>Question Multiple Choice | Digix</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Question Multiple Choice</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Multiple Choice</li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Question Multiple Choice Table</h4>
                                <div class="table-responsive m-t-40">
                                <div id="notif"><?php echo $this->session->flashdata('notif'); ?></div>
                                <a href="<?php echo base_url(); ?>adm/question/add_question/<?php echo $question_type;?>"><button type="button" class="btn btn-info btn-sm" aria-haspopup="true" aria-expanded="false"><i class="ti-plus"></i> Add</button></a>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <?php $no=1; foreach($select_question_get_by_type->result() as $row_question){ ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                ...
                                                <td>
                                                    <!-- <a href="<?php //echo base_url(); ?>adm/question/update_question/<?php //echo $row_question->id_question.'/'.$row_question->question_type; ?>">
